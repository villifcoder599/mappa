      ...
      var TabsPage = /*#__PURE__*/function () {
        ...
        _createClass(TabsPage, [{
          ...
          value: function ngOnInit() {
            if (window.localStorage.getItem('unread') != null) this.unread = JSON.parse(window.localStorage.getItem('unread'));
          }
        }, {
          key: "clear_badge",
          value: function clear_badge() {
            this.unread = 0;
            window.localStorage.setItem('unread', JSON.stringify(this.unread));
          }
        }, {
          key: "update_badge",
          value: function update_badge() {
            this.unread++;
            window.localStorage.setItem('unread', JSON.stringify(this.unread));
          }
        }]);
